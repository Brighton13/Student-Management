      ...
      <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="width: 350px;">
          <div class="offcanvas-body">
              <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                      <a class="nav-link fs-5" href="#"  data-bs-toggle="collapse" data-bs-target="#submenu2" aria-expanded="false" aria-controls="submenu2">
                          <i class="fas fa-user"></i>  Students
                      </a>
                      <div class="collapse" id="submenu2">
                          <ul class="nav flex-column">
                              <li class="nav-item">
                                  <a class="nav-link" href="" data-page="<?= site_url('Admin/students') ?>"><i class="fas fa-cog"></i> Enroll</a>
                              </li>
                              <li class="nav-item">
                                  <a class="nav-link" href="#" data-page=""><i class="fas fa-envelope"></i> View Students</a>
                              </li>
                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse" id="submenu3">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fas fa-cog"></i> Generate Invoices</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-page=""><i class="fas fa-envelope"></i> Students payment status</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-page=""><i class="fas fa-envelope"></i> Payroll details</a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link fs-5" href="#" data-page="" data-bs-toggle="collapse" data-bs-target="#submenu4" aria-expanded="false" aria-controls="submenu4">
                        <i class="fa-solid fa-book-open"></i>  Subjects 
                    </a>
                    <div class="collapse" id="submenu4">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-page=""><i class="fas fa-cog"></i> Add Subject</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-page=""><i class="fas fa-envelope"></i> View Subjects</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="submenu5">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-page=""><i class="fas fa-cog"></i> Create Announcement</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-page=""><i class="fas fa-envelope"></i> View Announcements</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="submenu6">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-page=""><i class="fas fa-cog"></i> Add Grade</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-page="<?= site_url('Admin/classes') ?>"><i class="fas fa-envelope"></i> View Grades</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="submenu7">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-page="<?= site_url('Admin/reults') ?>"><i class="fas fa-cog"></i> Publish Results</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-page=""><i class="fas fa-envelope"></i> View Results </a>
                            </li>
