...
<script>
    ...
    var action = 'get_teacher';

    if (selectedGrade != '') {
        $.ajax({
            url: '<?= base_url('Admin/GetGradeTeacher') ?>',
            method: 'POST',
            data: { selectedGrade: selectedGrade, action: action },
            dataType: 'JSON',
            success: function(data) {
                // Clear existing options in teacherSelect
                $('#teacher').empty();
                ...
                $.each(data, function(index, teacher) {
                    html += '<option value="' + teacher.Identity + '">' + teacher.FirstName + ' ' + teacher.LastName + '</option>';
                });
...
<head>
    ...
    <title>Admin Dashboard</title>
    <link rel="shortcut icon" href="assets/img/logo hks.jpg">
